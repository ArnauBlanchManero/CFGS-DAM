...
char cifrado_cesar(char frase, int saltos){
	...
	if(frase >= 'A' && frase <= 'Z'){//Comparamos el caracter dentro de la tabla ascii para saber si es una letra mayúscula
	...
	} else if(frase >= 'a' && frase <= 'z'){//Comparamos el caracter dentro de la tabla ascii para saber si es una letra minúscula
